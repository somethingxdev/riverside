        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="p-10">
            <DialogHeader className="mb-6">
              <DialogTitle className="text-3xl md:text-5xl font-heading">
                Thank you for your INTEREST!
              </DialogTitle>
              <DialogDescription className="max-w-[440px] text-sm sm:text-base">
                To allow us to contact you and consider your candidacy, please leave your contact
                information.
              </DialogDescription>
            </DialogHeader>
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-w-[440px]">
                ...
                <FloatingInput
                  {...register('employment')}
                  id="employment"
                  label="Previous/Current Employment"
                />

                <FloatingInput
                  {...register('reason')}
                  id="reason"
                  label="Why would you like to Join Riverside Roofing Materials"
                />
                ...
                <DialogFooter className="mt-6">
                  <button type="submit" className="w-full h-12.5 md:h-15 transition-colors px-4 py-2 text-base bg-primary text-white hover:bg-primary/90 focus-visible:outline-primary inline-flex items-center justify-center gap-1.5 rounded-xl font-semibold whitespace-nowrap uppercase">
                    SEND
                  </button>
                </DialogFooter>
              </form>
