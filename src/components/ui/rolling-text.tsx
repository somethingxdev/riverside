...
function RollingText({
 ...
 <span data-slot="rolling-text mx-auto block" {...props} ref={ref}>
      {characters.map((char, idx) => (
        <span key={idx} className="relative inline-block perspective-[9999999px] transform-3d w-auto xl:text-[350px] 2xl:text-[470px]/none font-heading" aria-hidden="true">
          <motion.span
